...
import me.izac.credit.application.system.dto.request.CustomerUpdateDto
import me.izac.credit.application.system.dto.response.CustomerView
import me.izac.credit.application.system.entity.Customer
import me.izac.credit.application.system.service.impl.CustomerService
...
class CustomerResource(
  ...
  fun upadateCustomer(
    ...
    return ResponseEntity.status(HttpStatus.OK).body(
        me.izac.credit.application.system.dto.response.CustomerView(
            customerUpdated
        )
    )
  }
